...
public final class SwaggerTags {
    ...
    public static final String USER_CREATE_DESC = """
        ➕ <b>개발자 인력 등록</b><br>
        새로운 개발자 정보를 시스템에 등록합니다.<br>
        요청 본문에는 개발자 이름, 나이, 연락처, 등급, 주소, 성별 등의 정보를 포함해야 합니다.<br>
        성공 시 등록된 개발자 정보와 함께 <code>201 Created</code> 응답을 반환합니다.
        """;
